...
class CustomRangePicker {
  static Future<DateTimeRange?> onShow(
    ...
    return await showRangePickerDialog(
      ...
      singleSelectedCellTextStyle: AppFontStyle.styleW500(AppColors.whiteColor, 14),
      singleSelectedCellDecoration: BoxDecoration(color: AppColors.primaryColor, shape: BoxShape.circle),
      currentDateTextStyle: AppFontStyle.styleW500(
        initialDateRange == null ? AppColors.whiteColor : AppColors.blackColor,
        16,
      ),
      currentDateDecoration: BoxDecoration(
        color: initialDateRange == null ? AppColors.secondaryColor : AppColors.transparent,
        shape: BoxShape.circle,
      ),
      daysOfTheWeekTextStyle: AppFontStyle.styleW500(AppColors.blackColor.withValues(alpha: 0.6), 14),
