            ...
            children: [
              Padding(
                ...
                child: Text(
                  ...
                  style: AppFontStyle.styleW6002(AppColors.whiteColor.withValues(alpha: 0.80), 14),
                ),
              ),
              5.height,
              Padding(
                ...
                child: Row(
                  children: [
                    5.width,
                    Text(
                      Database.isDemoLogin == true ? "620" : Database.coin.toString().split('.')[0],
                      style: TextStyle(
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Text(
                            ...
                            style: AppFontStyle.styleW800(AppColors.rechargeCoinTxtColor, 22),
                          ),
                        ),
                      ),
                      Expanded(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Stack(
                                    ...
                                    children: [
                                      Container(
                                        decoration: BoxDecoration(
                                          color: item.isFeatured == true ? AppColors.lightYellowColor : AppColors.whiteColor.withValues(alpha: 0.20),
                                          borderRadius: BorderRadius.circular(24),
                                          image: item.isFeatured == true
                                              ? const DecorationImage(
                                                  image: AssetImage(AppAsset.premiumBgImg),
                                                  fit: BoxFit.cover,
                                                )
                                              : null,
                                          border: Border.all(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            const Image(
                                              image: AssetImage(AppAsset.rechargeCoin),
                                              height: 85,
                                              width: 85,
                                            ).paddingOnly(top: 20),
                                            Text(
                                              ...
                                              style: AppFontStyle.styleW900(
                                                  item.isFeatured == true ? AppColors.orangeTxtColor2 : AppColors.whiteColor, 18),
                                            ),
                                            ...
                                            GestureDetector(
                                              ...
                                              child: Container(
                                                height: 30,
                                                decoration: BoxDecoration(
                                                  color: item.isFeatured == true ? AppColors.colorDarkBrown : AppColors.whiteColor,
                                                ...
                                                child: Center(
                                                  child: Text(
                                                    ...
                                                    style: AppFontStyle.styleW900(
                                                        item.isFeatured == true ? AppColors.lightYellowColor : AppColors.orangeTxtColor2, 18),
                                                  ),
                                                ),
                                      ...
                                      if (item.bonusCoins != null && item.bonusCoins! > 0)
                                        Positioned(
                                          top: 10,
                                          right: -25,
                                          child: Transform.rotate(
                                            ...
                                            child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                gradient: item.isFeatured == true
                                                    ...
                                                    : const LinearGradient(
                                                        colors: [
                                                          AppColors.colorPinkGradient,
                                                          AppColors.colorBlueGradient,
                                                        ],
                                                        begin: Alignment.topLeft,
                                                        end: Alignment.bottomRight,
                                                      ),
                                              ...
                                              child: Padding(
                                                padding: const EdgeInsets.only(left: 20), // 👈 pushes text slightly down
                                                child: Text(
                                                  "VIP + ${item.bonusCoins}",
                                                  style: AppFontStyle.styleW900(
                                                      item.isFeatured == true ? AppColors.lightYellowColor : AppColors.whiteColor, 12),
                                                  maxLines: 1,
