...
import 'package:figgy/pages/withdraw_page/widget/withdraw_widget.dart';
import 'package:figgy/routes/app_routes.dart';
import 'package:figgy/shimmer/withdraw_shimmer.dart';
              ...
              child: Row(
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      decoration: BoxDecoration(color: AppColors.redColor2, borderRadius: BorderRadius.circular(60), boxShadow: const [
                        BoxShadow(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            ...
                            style: AppFontStyle.styleW800(AppColors.whiteColor, 15),
                          ),
                        ],
                                ...
                                child: Column(
                                  ...
                                  children: [
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                decoration: const BoxDecoration(
                                                  ...
                                                  // color: Colors.red,
                                                  image: DecorationImage(image: AssetImage(AppAsset.walletBgImage), fit: BoxFit.cover),
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            ...
                                                            style: TextStyle(
                                                              ...
                                                              shadows: [
                                                                Shadow(
                                                                  color: AppColors.blackColor.withValues(alpha: 0.64),
                                                                ...
                                                                GetBuilder<WithdrawController>(
                                                                  builder: (logic) {
                                                                    return Text(
                                                                      ...
                                                                      style: AppFontStyle.styleW700(AppColors.orangeTxtColor, 14),
                                                                    );
                                                                  },
                                                                ),
                                                                8.width,
                                        ...
                                        builder: (logic) {
                                          return DropdownButtonHideUnderline(
                                            child: DropdownButton2(
                                              ...
                                              hint: Text(
                                                EnumLocale.txtSelectPaymentGateway.name.tr,
                                                style: AppFontStyle.styleW500(AppColors.whiteColor, 14), // white color
                                              ),
                                              value: logic.selectedPaymentMethod,
                                              onChanged: (index) {
                                                logic.onChangePaymentMethod(index!);
                                                logic.update([AppConstant.onChangePaymentMethod]);
                                              },
                                              items: List.generate(
                                                logic.withdrawMethods.length,
                                                (index) {
                                                  final item = logic.withdrawMethods[index];
                                                  return DropdownMenuItem(
                                                    value: index,
                                                    child: Row(
                                                      children: [
                                                        Image.network(
                                                          Api.baseUrl + (item.image ?? ""),
                                                          height: 30,
                                                          width: 30,
                                                        ),
                                                        10.width,
                                              ...
                                              dropdownStyleData: DropdownStyleData(
                                                decoration: BoxDecoration(
                                                  color: AppColors.colorChat, // dropdown background translucent
                                    ...
                                    GetBuilder<WithdrawController>(
                                      id: AppConstant.onChangePaymentMethod,
                                      builder: (logic) =>
                                          controller.selectedPaymentMethod == null ? const Offstage() : Column(children: logic.inputFel),
                                    ),
                                  ],
                                ),
                              ),
