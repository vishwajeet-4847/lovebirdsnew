...
class GetDailyRewardCoinApi {
  ...
  static Future<GetDailyRewardCoinModel?> callApi({required String token, required String uid}) async {
    ...
    try {
      ...
      Utils.showLog("Get Daily Reward Coin Api Status code => ${response.statusCode}");
