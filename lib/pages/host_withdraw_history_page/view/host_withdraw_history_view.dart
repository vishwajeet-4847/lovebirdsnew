...
import 'package:figgy/shimmer/coin_history_shimmer_ui.dart';
                ...
                return Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      8.width,
                      controller.startDate == "All" || controller.endDate == "All"
                          ? const SizedBox()
                          : GestureDetector(
                              onTap: () async {
                          ...
                          builder: (controller) {
                            return controller.isLoading
                                ...
                                : controller.withdrawHistory.isEmpty
                                    ? NoDataFoundWidget().paddingOnly(bottom: 150)
                                    : RefreshIndicator(
                                        onRefresh: () async {
                                          controller.withdrawHistory.clear();
                                          GeHostWithdrawHistoryApi.startPagination = 1;
                                        ...
                                        child: ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            final hostData = controller.withdrawHistory[index];
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Center(
                                                      child: Image.asset(AppAsset.icCoin, width: 35),
                                                    ),
                                                  ),
                                                  10.width,
                                                  Expanded(
                                                        ...
                                                        Text(
                                                          hostData.status == 1
                                                              ...
                                                              : hostData.status == 2
                                                                  ? "Withdraw"
                                                                  : "Cancel Withdraw",
                                                          style: hostData.status == 1
                                                              ? AppFontStyle.styleW700(AppColors.colorLightYellow, 15)
                                                              : hostData.status == 2
                                                                  ? AppFontStyle.styleW700(AppColors.redColor, 15)
                                                                  : AppFontStyle.styleW700(AppColors.colorOrangeWithdraw, 15),
                                                          maxLines: 1,
                                                        ),
                                                        Text(
                                                          hostData.requestDate ?? "",
                                                          style: AppFontStyle.styleW500(AppColors.historyTextColor, 10),
                                                        ),
                                                        2.height,
                                                        Text(
                                                  ...
                                                  Container(
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        Text(
                                                          hostData.status == 1 || hostData.status == 3 ? "" : "-",
                                                          style: AppFontStyle.styleW700(
                                                            hostData.status == 1
                                                                ? AppColors.colorLightYellowBg
                                                                : hostData.status == 2
                                                                    ? AppColors.colorRedBg
                                                                    : AppColors.colorOrangeWithdrawBg,
                                                            15,
                                                          ),
                                                        ),
                                                        Text(
