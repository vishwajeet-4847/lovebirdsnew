...
class HostDetailMediaView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        HostDetailTitle(title: EnumLocale.txtGallery.name.tr).paddingOnly(left: 14),
        10.height,
          ...
          builder: (logic) {
            if (logic.mixedMedia.isEmpty) {
              return const Padding(
                ...
                child: Text("No media found", style: TextStyle(color: Colors.white)),
              );
            }
            return SizedBox(
              height: 190,
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    ...
                    child: item.isVideo
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (_) => ReelsPlayerView(
                                    ...
                                    initialIndex: logic.videoUrls.indexOf(item.url),
                                  ),
                                ),
                              );
                            },
                        ...
                        : GestureDetector(
                            onTap: () {
                              Get.to(FullScreenImageView(imageUrl: logic.hostDetailModel?.host?.photoGallery?[index] ?? ""));
                            },
  ...
  Widget _buildVideoItem(HostDetailController logic, MediaItem item) {
    ...
    final thumbPath = (videoIndex != -1 && videoIndex < logic.thumbnails.length) ? logic.thumbnails[videoIndex] : null;
    ...
    return Stack(
      ...
      children: [
        thumbPath != null && thumbPath.isNotEmpty
            ...
            : Center(
                child: Image.asset(AppAsset.icPlaceHolder, width: 80, height: 80),
              ),
        Align(
