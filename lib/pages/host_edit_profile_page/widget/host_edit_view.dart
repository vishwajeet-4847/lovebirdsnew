...
import 'package:LoveBirds/pages/host_edit_profile_page/widget/edit_reels_player_view.dart';
import 'package:LoveBirds/pages/host_edit_profile_page/widget/language.dart';
    ...
    return Column(
      ...
      children: [
                    ...
                    : GestureDetector(
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                color:
                                    AppColors.colorGry1.withValues(alpha: 0.50),
                              ),
                              borderRadius: BorderRadius.circular(6)),
                          child: Text(
                            EnumLocale.txtAddMore.name.tr,
                            style: AppFontStyle.styleW600(
                                AppColors.whiteColor.withValues(alpha: 0.40),
                                12),
        ...
        GetBuilder<HostEditProfileController>(
          builder: (logic) {
            return GestureDetector(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: logic.selectedLanguages.isEmpty
                      ? AppColors.colorSelectedImpression.withValues(alpha: 0.7)
                          ...
                          return Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () =>
                                      logic.toggleSelectionLanguage(category),
                                  child: Icon(
                                    Icons.close,
                                    size: 18,
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      EnumLocale.txtAddMore.name.tr,
                      style: AppFontStyle.styleW600(
                          AppColors.whiteColor.withValues(alpha: 0.40), 12),
                    ).paddingOnly(left: 8, right: 7, top: 5, bottom: 5),
                  ),
                );
              },
        ...
        GetBuilder<HostEditProfileController>(
          ...
          builder: (logic) {
            final totalVideos =
                logic.videoUrls.length + logic.newLocalVideos.length;
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          top: 3,
                          child: InkWell(
                            onTap: () => Get.find<HostEditProfileController>()
                                .onDeleteVideo(index, isServer: isServer),
                            child: Image.asset(AppAsset.icEditDelete,
                                height: 45, width: 45),
                          ),
                        ),
                        Positioned(
                          ...
                          child: InkWell(
                            onTap: () => Get.find<HostEditProfileController>()
                                .onReplaceVideo(index, isServer: isServer),
                            child: Image.asset(AppAsset.icEditImage,
                                height: 45, width: 45),
                          ),
                        ),
                        Positioned.fill(
                          child: Align(
                            ...
                            child: Image.asset(AppAsset.icPlay,
                                height: 50, width: 50),
                          ),
                        ),
                      ],
    ...
    children: [
      GetBuilder<HostEditProfileController>(
        builder: (logic) {
          ...
          final bool hasImage =
              logic.images[index] != null && logic.images[index]!.isNotEmpty;
