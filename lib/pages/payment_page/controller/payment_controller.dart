...
import 'package:LoveBirds/common/common_payment.dart';
...
import 'package:LoveBirds/pages/payment_page/api/purchase_coin_plan_api.dart';
import 'package:LoveBirds/pages/payment_page/api/purchase_vip_plan_api.dart';
import 'package:LoveBirds/pages/payment_page/payment/flutter_wave/flutter_wave_services.dart';
import 'package:LoveBirds/pages/payment_page/payment/in_app_purchase/iap_callback.dart';
import 'package:LoveBirds/pages/payment_page/payment/in_app_purchase/in_app_purchase_helper.dart';
import 'package:LoveBirds/pages/payment_page/payment/razor_pay/razor_pay_view.dart';
import 'package:LoveBirds/pages/payment_page/payment/stripe/stripe_service.dart';
...
class PaymentScreenController extends GetxController implements IAPCallback {
  ...
  final paymentMethodList = [
    ...
    {
      "icon": Platform.isIOS ? AppAsset.icAppleIcon : AppAsset.icGoogle,
